    ...
    > SetChildrenCommands<'n, 'p, 'c1, 'cw, 'cs, 'world, 'ec, 'a, 'alloc, N, C, R>
{
    ...
    pub fn ignore_context(
        self,
    ) -> SetChildrenCommands<'n, 'p, 'c1, 'cw, 'cs, 'world, 'ec, 'a, 'alloc, N, (), R> {
        self.map_context(|_| &())
    }
    ...
    pub fn map_args<N2: PartialEq>(
        self,
        map: impl Fn(&N) -> &N2,
    ) -> SetChildrenCommands<'n, 'p, 'c1, 'cw, 'cs, 'world, 'ec, 'a, 'alloc, N2, C, R> {
        SetChildrenCommands {
    ...
    > SetChildrenCommands<'n, 'p, 'c1, 'cw, 'cs, 'world, 'ec, 'a, 'alloc, N, C, R>
{
    ...
    pub fn ordered_children_with_node_and_context(
        ...
        f: impl FnOnce(&'n N, &'c1 C::Wrapper<'cw, 'cs>, &mut OrderedChildCommands<R>),
    ) {
    ...
    pub fn unordered_children_with_node_and_context(
        ...
        f: impl FnOnce(&'n N, &'c1 C::Wrapper<'cw, 'cs>, &mut UnorderedChildCommands<R>),
    ) {
    ...
    pub fn ordered(
        ...
        f: impl FnOnce(&NodeArgs<'n, 'p, 'c1, 'cw, 'cs, N, C>, &mut OrderedChildCommands<R>),
    ) {
        if self.args.is_hot() {
    ...
    pub fn unordered(
        ...
        f: impl FnOnce(&NodeArgs<'n, 'p, 'c1, 'cw, 'cs, N, C>, &mut UnorderedChildCommands<R>),
    ) {
        if self.args.is_hot() {
...
impl<'n, 'p, 'c1, 'cw, 'cs, 'world, 'ec, 'a, 'alloc, R: MavericRoot>
    SetChildrenCommands<'n, 'p, 'c1, 'cw, 'cs, 'world, 'ec, 'a, 'alloc, (), (), R>
{
...
impl<'n, 'p, 'c1, 'cw, 'cs, 'world, 'ec, 'a, 'alloc, N: PartialEq, R: MavericRoot>
    SetChildrenCommands<'n, 'p, 'c1, 'cw, 'cs, 'world, 'ec, 'a, 'alloc, N, (), R>
{
    ...
    SetChildrenCommands<'n, 'p, 'c1, 'cw, 'cs, 'world, 'ec, 'a, 'alloc, (), C, R>
{
    pub fn ordered_children_with_context(
        ...
        f: impl FnOnce(&'c1 C::Wrapper<'cw, 'cs>, &mut OrderedChildCommands<R>),
    ) {
    ...
    pub fn unordered_children_with_context(
        ...
        f: impl FnOnce(&'c1 C::Wrapper<'cw, 'cs>, &mut UnorderedChildCommands<R>),
    ) {
